...
const fixture = await fs.readFile(path.join(macosRoot, "tests", "fixtures", "background.jpg"));
assert.deepEqual(readImageMetadata(fixture, ".jpg"), {
  width: 1920,
  height: 1200,
  ratio: 1.6,
  wide: false,
...
const malformedJpeg = Buffer.from(fixture);
malformedJpeg[0] = 0;
